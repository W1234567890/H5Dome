<template>
	<div class="bcy">
		...
		<div class="tpBanner houseBanner" id="lk">
			...
			<ul class="ctBOX">
				<li class="cont" @click="openHouseDetail" id="23073160">					
					<img src="https://opres.gongyujia.com/H5/different/23073160.jpg" class="houseImg" id="23073160"/>
					<div class="houseTit" id="23073160">
						<img src="https://opres.gongyujia.com/H5/different/servicesStu04.jpg" id="23073160"/>
						<p id="23073160">下梅林 绿景虹湾 楼下地铁口商场 精装电梯三房</p>
						<span id="23073160"><span id="23073160">¥ 8000</span>/月</span>								
					</div>					
				</li>											
			</ul>    			
		</div>
		...
		<div class="tpBanner houseBanner">
			...
			<ul class="ctBOX">
				<li class="cont"  @click="openHouseDetail" id="23073106">
					<img src="https://opres.gongyujia.com/H5/different/23073106S.jpg" class="houseImg" id="23073106"/>
					<div class="houseTit" id="23073106">
						<img src="https://opres.gongyujia.com/H5/different/servicesStu04.jpg"  id="23073106"/>
						<p  id="23073106">汇港名苑 蛋壳公寓直租</p>						
						<span  id="23073106"><span  id="23073106">¥ 1960</span>/月</span>					
					</div>
				</li>				  				
			</ul>    			
		</div>
		...
		<div class="tpBanner houseBanner">
			...
			<ul class="ctBOX">
				<li class="cont" @click="openHouseDetail" id="23072422">
					<img src="https://opres.gongyujia.com/H5/different/23072422.jpg" class="houseImg" id="23072422"/>
					<div class="houseTit" id="23072422">
						<img src="https://opres.gongyujia.com/H5/different/servicesStu04.jpg" id="23072422" />
						<p id="23072422">橄榄鹏苑 2室1厅1卫 </p>						
						<span id="23072422"><span id="23072422">¥ 3000</span>/月</span>					
					</div>
				</li>   				
			</ul>    			
		</div>
		...
		<div class="tpBanner houseBanner">
			...
			<ul class="ctBOX">
				<li class="cont" @click="openHouseDetail" id="23073052">
					<img src="https://opres.gongyujia.com/H5/different/23073052.jpg" class="houseImg" id="23073052"/>
					<div class="houseTit" id="23073052">
						<img id="23073052" src="https://opres.gongyujia.com/H5/different/servicesStu04.jpg" />
						<p id="23073052">福田上沙押一付一 </p>
						<span id="23073052"><span id="23073052">¥ 2320</span>/月</span>
					</div>
				</li>  				
			</ul>    			
		</div>
		...
		<div class="tpBanner houseBanner last">
			...
			<ul class="ctBOX">				
				<li class="cont" @click="openHouseDetail" id="23072476">
					<img src="https://opres.gongyujia.com/H5/different/23072476.jpg" class="houseImg" id="23072476"/>
					<div class="houseTit" id="23072476">
						<img src="https://opres.gongyujia.com/H5/different/servicesStu04.jpg" id="23072476"/>
						<p id="23072476">香榭里花园 蛋壳公寓直租 精装房间 智能门锁</p>
						<span id="23072476"><span id="23072476">¥ 5500</span>/月</span>						 						
					</div>
				</li>   				
			</ul>    			
		</div>
...
export default {
	data(){
		return {
			...
			shareInfo:{
			   ...
			   "share_url":"https://special.gongyujia.com/#/beautifulHouseSZ",          //链接
    ...
    mounted() {
		...
		let data = {
			   "share_title":"歌词中的美丽房屋",        //分享标题
			   "share_url":"https://special.gongyujia.com/#/beautifulHouseSZ",          //链接          //链接
			   "share_image":"https://opres.gongyujia.com/app/ads/b04f46f2d88c280747c89d5d4a2d6ef5.png",        //图片
