<template>
	<div>
		...
		<div class="houseBanner">
			...
			<ul class="ctBOX">
				<li class="cont" @click="openHouseDetail" v-for="(im,key) in houseList" :key="key" v-if="im.house_oid == 21019882">
					<a>
				...
				<li class="cont" @click="openHouseDetail" v-for="(im,key) in houseList" :key="key" v-if="im.house_oid == 21019270">
					<a>
						<img v-lazy="im.cover_pic" class="houseBjImg"  :id="im.house_oid"/>
						<div class="houseList"  :id="im.house_oid"></div>
						<span class="price"  id="im.house_oid"><span>{{im.price}}</span>/月</span>	
		...
		<div class="houseBanner">
			...
			<ul class="ctBOX">	
				<li class="cont" @click="openHouseDetail" v-for="(im,key) in houseList" :key="key" v-if="im.house_oid == 21019900">
					<a>
						<img v-lazy="im.cover_pic" class="houseBjImg"  :id="im.house_oid"/>
						<div class="houseList"  :id="im.house_oid"></div>
						<span class="price"  id="im.house_oid"><span>{{im.price}}</span>/月</span>	
				...
				<li class="cont" @click="openHouseDetail" v-for="(im,key) in houseList" :key="key" v-if="im.house_oid == 21019990">
					<a>
						<img v-lazy="im.cover_pic" class="houseBjImg"  :id="im.house_oid"/>
						<div class="houseList"  :id="im.house_oid"></div>
						<span class="price"  id="im.house_oid"><span>{{im.price}}</span>/月</span>	
		...
		data(){
			return {
				...
				shareInfo:{
				   ...
				   "share_url":"https://special.gongyujia.com/#/ItTheGuideCDNew",          //链接
		...
		methods: {	
			...
			init(){
				...
				let url = "Specials/house_list_it",
				    	data = { "filter_type":"normal","district_id":"806","os_type":"adr","os_version":'1',"network":'110',"version_code":'1',"area_code":"028","g_uid":"","channel":"","app_device":"","package_name":""};																		
