<template>
	<div>
		<div class="breakList">
	  		<img src="https://opres.gongyujia.com/H5/tide/breakImg001.jpg" v-if="topBanner" />
	  		<div class="loginImg">
	  		...
	  		<div class="breakMb">
	  			<img src="https://opres.gongyujia.com/H5/tide/breakImg002.jpg" class="topBanner"/>
	  			<img src="https://opres.gongyujia.com/H5/tide/breakImg003.jpg" />  			
	  			<img src="https://opres.gongyujia.com/H5/tide/breakImg004.jpg" />
	  			<img src="https://opres.gongyujia.com/H5/tide/breakImg005.jpg" />
	  			<img src="https://opres.gongyujia.com/H5/tide/breakImg006.jpg" />
	  			<img src="https://opres.gongyujia.com/H5/tide/breakImg007.jpg" />
	  			<img src="https://opres.gongyujia.com/H5/tide/breakImg008.jpg" />
	  			<img src="https://opres.gongyujia.com/H5/tide/breakImg009.jpg" />
	  			<img src="https://opres.gongyujia.com/H5/tide/breakImg010.jpg" />
	  			<img src="https://opres.gongyujia.com/H5/tide/breakImg011.jpg" />
	  			<img src="https://opres.gongyujia.com/H5/tide/breakImg012.jpg" />
	  			<img src="https://opres.gongyujia.com/H5/tide/breakImg013.jpg" />
	  			<img src="https://opres.gongyujia.com/H5/tide/breakImg014.jpg" style="margin: 0;"/>
	  		</div>	  		
	  	</div>
...
export default {
	data(){
		return {
				...
				flag:true,
				shareInfo:{
				   "share_title":"北上广本地潮玩活动速报",        //分享标题
				   "share_url":"https://special.gongyujia.com/#/tideBSG",          //链接
	...
	methods: {	
	    ...
	    setclick(bridge){
			...
			document.getElementById('shareBut').onclick = function(e){
				...
				let data = {
				   "share_title":"北上广本地潮玩活动速报",        //分享标题
				   "share_url":"https://special.gongyujia.com/#/tideBSG",          //链接          //链接
				   "share_image":"https://opres.gongyujia.com/app/ads/b04f46f2d88c280747c89d5d4a2d6ef5.png",        //图片
...
//		        	$('.shareBut').css('margin','15px 35% 450px')
		...
		init(){
			...
			let url = "house_list",			     
			    data = {"os_type":"adr","os_version":'1',"network":'110',"version_code":'1',"area_code":this.code,"g_uid":"","channel":"","app_device":"","package_name":"",'page':4,'page_size':'20','filter_type':'normal','price_bottom':2000};
            this.getByUrl({data,url}, res=>{
				this.ajax({
					url : res.url,
					data : res.data,						
