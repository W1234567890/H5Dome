    ...
    data(){
		return {
			...
			shareInfo:{
			   ...
			   "share_url":"https://special.gongyujia.com/#/educationDY",          //链接
		...
		getRed(){	
			...
			if(this.telNubmer.length == 11 && res.test(this.telNubmer)){
				let url = "Coupon/long_program",
			    	data = {"os_type":"adr","os_version":'1',"network":'110',"version_code":'1','phone_bind':this.telNubmer,"g_uid":"","channel":"","app_device":"","package_name":"","channel_type":3,"type":this.source};											
